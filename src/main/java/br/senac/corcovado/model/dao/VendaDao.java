    ...
    public static Venda obter(long id) throws SQLException {
        ...
        try {
            ...
            if (result.next()) {
                ...
                venda.setCliente(PessoaDao.obter(result.getLong("cliente_id")));
                venda.setEndereco(EnderecoDao.obter(result.getLong("endereco_id")));
                venda.setDesconto(DescontoDao.obter(result.getLong("desconto_id")));
