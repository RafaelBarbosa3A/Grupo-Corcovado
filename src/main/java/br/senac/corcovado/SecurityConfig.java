...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http.csrf().disable()
            ...
            .and()
                .authorizeRequests()
                    .antMatchers("/comercio/carrinho/**", "/comercio/venda/**", "/comercio/recibo/**", "/comercio/compras/**", "/atendimentos/**").authenticated()
                    .antMatchers("/", "/css/**", "/js/**", "/images/**", "/console/**", "/comercio/**", "/cadastro/**", "/estatico/**").permitAll()
